...
const TrendingRepositories = () => {
  return (
    <div className="trendingRepositories">
      <span className="trendingRepositories__title">
        <LuLineChart />
        <span className="trendingRepositories-title__text"> Trending repositories · </span>
        <a href="https://github.com/trending" className="vb-ankor">
          Show More
        </a>
      </span>
